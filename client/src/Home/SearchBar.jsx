...
function SearchBar() {
  ...
  return (
    <form
      ...
      className="bg-white rounded-3xl shadow-2xl p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4"
    >
      {/* Destination */}
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 outline-none focus:ring-2 focus:ring-yellow-500"
        />
      </div>
